...
let track1box = document.getElementById("show-track-1");
let track2box = document.getElementById("show-track-2");
...
function displaySchedule() {
    ...
    for (let i = 0; i < schedule.length; i++) {
        const track = schedule[i].tracks;
        if((track1box.checked && (track.indexOf(1)>=0))||(track2box.checked &&(track.indexOf(2)>=0))) {
...
track1box.addEventListener("click", displaySchedule);
track2box.addEventListener("click", displaySchedule);
